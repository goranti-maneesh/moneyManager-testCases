...
describe(':::RJSCPIK4G2_TEST_SUITE_1:::Money Manager tests', () => {
  ...
  it(':::RJSCPIK4G2_TEST_1:::When a transaction is added, then the page should consist of at least one HTML list item and the transactionsList should be rendered using a unique key as a prop for each transaction item:::5:::', () => {
    ...
    render(<App />)
    console.log(
      screen.getByTestId('balanceAmount').textContent,
      screen.getByTestId('incomeAmount').textContent,
      screen.getByTestId('expensesAmount').textContent,
      -2,
    )
    userEvent.type(
  ...
  it(':::RJSCPIK4G2_TEST_5:::Page should initially consist of an HTML paragraph element with data-testid attribute value as "balanceAmount" and text content as "0":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPIK4G2_TEST_8:::Page should initially consist of an HTML paragraph element with data-testid attribute value as "incomeAmount" and text content as "0":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPIK4G2_TEST_11:::Page should initially consist of an HTML paragraph element with data-testid attribute value as "expensesAmount" and text content as "0":::5:::', () => {
    render(<App />)
  ...
  it(':::RJSCPIK4G2_TEST_39:::When a transaction is added, and the HTML button with data-testid as "delete" is clicked, the transaction item should be removed:::5:::', () => {
    render(<App />)
    userEvent.type(
      screen.getByRole('textbox', {name: /TITLE/i, exact: false}),
      'Salary',
  ...
  it(':::RJSCPIK4G2_TEST_40:::When a single transaction is added, and the HTML button with data-testid as "delete" is clicked, then the Balance, Income, Expenses should be updated to their initial values:::5:::', () => {
    render(<App />)
